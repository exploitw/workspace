...
<body>
	<form  name = "canride" action = "" method="post">
	...
	선호 놀이 기구:
		롤러코스터 <input type="radio" name="attractions" value="rollercoaster" >
		범퍼카 <input type="radio" name="attractions" value="bumpercar">
		회전목마 <input type="radio" name="attractions" value="marrygoround">
		<!-- <input type="submit"> -->
